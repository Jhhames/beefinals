...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-md">
    ...
    <div class="wrapper">
                        ...
                        <div class="topbar-actions">
                            ...
                            <div class="btn-group-red btn-group">
                                ...
                                <ul class="dropdown-menu-v2" role="menu">
                                    <li class="active">
                                        <a data-toggle="modal" data-target="#addEmployee"> <span
                                                class="icon-user"></span> New Employee</a>
                                    </li>
                                    <li>
                                        <a data-toggle="modal" data-target="#addTask"> <span
                                                class="icon-calculator"></span> New Task</a>
                                    </li>
                                    <li>
                                        <a data-toggle="modal" data-target="#addTraining"> <span
                                                class="icon-graduation"></span> New Training</a>
                                    </li>
                                    <li>
                                        <a data-toggle="modal" data-target="#addAdmin"> <span
                                                class="icon-wrench"></span> New Admin</a>
                                    </li>
                                    <li>
                                        <a data-toggle="modal" data-target="#addAppraisal"> <span
                                                class="icon-like"></span> New Appraisal</a>
                                    </li>
                                    <li>
                                        <a data-toggle="modal" data-target="#addPassword"> <span
                                                class="icon-key"></span> Change Password </a>
                                    </li>
                                </ul>
                            </div>
        ...
        <div class="container-fluid">
                            ...
                            <div class="widget-thumb-wrap">
                                ...
                                <div class="widget-thumb-body">
                                    ...
                                    <span class="widget-thumb-body-stat" data-counter="counterup"
                                        data-value="{{ count($employees) }}">0</span>
                                </div>
                            </div>
                        </div>
                        <!-- END WIDGET THUMB -->
                        ...
                        <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 bordered">
                            ...
                            <div class="widget-thumb-wrap">
                                ...
                                <div class="widget-thumb-body">
                                    ...
                                    <span class="widget-thumb-body-stat" data-counter="counterup"
                                        data-value="{{ count($pending) }}">0</span>
                                </div>
                            </div>
                        </div>
                        <!-- END WIDGET THUMB -->
                        ...
                        <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 bordered">
                            ...
                            <div class="widget-thumb-wrap">
                                ...
                                <div class="widget-thumb-body">
                                    <span class="widget-thumb-subtitle"></span>
                                    <span class="widget-thumb-body-stat" data-counter="counterup"
                                        data-value="{{count($pendingTasks)}}">0</span>
                                </div>
                            </div>
                        </div>
                        <!-- END WIDGET THUMB -->
                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title tabbable-line">
                                ...
                                <ul class="nav nav-tabs">
                                    <li>
                                        <a data-toggle="modal" data-target="#apprMod"> View All </a>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="portlet_comments_1">
                                        ...
                                        <div class="mt-comments">
                                            ...
                                            @if (isset($appraisals))
                                            @foreach ($appraisals->take(3) as $item)
                                            <div class="mt-comment">
                                                ...
                                                <div class="mt-comment-body">
                                                    ...
                                                    <div class="mt-comment-text">
                                                        ...
                                                        <form action="/admin/download/appraisal/{{$item->id}}" method="POST" id="appraisal-download{{$item->id}}">
                                                            @csrf
                                                        </form>
                                                    </div>
                    ...
                    <div class="col-lg-6 col-xs-12 col-sm-12">
                        <div class="portlet light bordered">
                            <div class="portlet-title tabbable-line">
                                ...
                                <ul class="nav nav-tabs">
                                    <li>
                                        <a href="" data-toggle="modal" data-target="#leaveMod"> view all </a>
                                    </li>
                                                    ...
                                                    <div class="mt-action-row">
                                                        <div class="mt-action-info ">
                                                            ...
                                                            <div class="mt-action-details ">
                                                                <span class="mt-action-author"> {{ $item->employee }}
                                                                </span>
                                            ...
                                            <div class="mt-action">
                                                ...
                                                <div class="mt-action-body">
                                                    <div class="mt-action-row">
                                                        ...
                                                        <div class="mt-action-buttons ">
                                                            <form action="{{ url('/admin/approveLeave/'.$item->id) }}"
                                                                id="approve_form" method="POST">
                                                                @csrf
                                                            </form>
                        ...
                        <div class="portlet light bordered">
                            ...
                            <div class="portlet-body">
                                <div class="scroller" style="height: 300px;" data-always-visible="1"
                                    ...
                                    <ul class="feeds">
                                        @if(isset($activities))
                                        @foreach ($activities->take(10) as $item)
                                        @switch($item->type)
                                        @case('user')
                                        <li>
                                            <div class="col1">
                            ...
                            <div class="portlet-title">
                                <div class="caption">
                                    ...
                                    <span class="caption-subject font-hide bold uppercase"> <span
                                            class="icon-users "></span> Employees</span>
                                </div>
                                <div class="actions">
                                    <div class="btn-group">
                                        <a class="btn green-haze btn-outline btn-circle btn-sm" href="/admin/employees"
                                            data-close-others="true"> View All <span class="icon-users"></span>
                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="icon-bubble font-dark hide"></i>
                                    <span class="caption-subject font-hide bold uppercase"> <span
                                            class="icon-wrench"></span> Admin</span>
                                </div>
                                <div class="actions">
                                    <div class="btn-group">
                                        {{-- <a class="btn green-haze btn-outline btn-circle btn-sm" href="/admin/employees"
            ...
            <!-- BEGIN FOOTER -->
            <p class="copyright"> 20i8 &copy; Employee Management System
    ...
    <nav class="quick-nav">
        ...
        <ul>
            ...
            <li>
                <a data-toggle="modal" data-target="#trainMod">
                    <span>View Training Excercises</span>
                    <i class="icon-users"></i>
                </a>
            </li>
            <li>
...
<![endif]-->
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('employer.employee.submit') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="Enter New Name" class="form-control" name="name"
                                id="empName">
                        </div>
                        <div class="form-group">
                            <label for="emailAddresss" class="font-weight-bold"><strong> Email Address </strong></label>
                            <input type="email" name="email" id="emailAddress"
                                placeholder="Enter Employee Email Address" class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="salary" id="empSalary" class="form-control" step="10000"
                                value="10000">
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('employer.password.submit') }}" method="POST">
                        ...
                        <div class="form-group">
                            <label for="emailAddresss" class="font-weight-bold"><strong> Confirm Password
                                </strong></label>
                            <input type="password" name="password_confirmation" id="emailAddress"
                                placeholder="Retype password to comfirm" class="form-control">
                        </div>
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('admin.task.submit') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="task" id="taskTask"
                                placeholder="Task Summary">
                        </div>

                        <div class="form-group">
                            <label for="taskDesc"><strong>Task Description</strong></label>
                            <textarea name="description" id="taskDesc" class="form-control" cols="30" rows="8"
                                placeholder="Full Task Description"></textarea>
                        </div>
    ...
    <div class="modal fade" id="addTraining" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title" id="exampleModalLabel">Assign Training Exercise</h3>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <!-- Default form register -->
                    <form action="{{ route('admin.training.submit') }}" method="POST">
                        @csrf
                        <div class="form-group">
                            <label for="tEmp"> <strong>Employee</strong> </label>
                            <select name="employee" id="tEmp" class="form-control">
                                @if(isset($employees))
                                @foreach ($employees as $item)
                                <option value="{{$item->name}}"> {{$item->name}} </option>
                        ...
                        <div class="form-group">
                            <label for="tTraining"><strong>Training</strong></label>
                            <input type="text" class="form-control" name="training" id="tTraining"
                                placeholder="Task Summary">
                        </div>

                        <div class="form-group">
                            <label for="taskDesc"><strong>Training Description</strong></label>
                            <textarea name="description" id="taskDesc" class="form-control" cols="30" rows="8"
                                placeholder="Full Task Description"></textarea>
                        </div>
    ...
    {{-- END OF MODAL 3  --}}
    {{-- MODAL 3 --}}
    <div class="modal fade" id="addAppraisal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('admin.appraisal.submit') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="summary" id="taskTask"
                                placeholder="Appraisal Summary">
                        </div>

                        <div class="form-group">
                            <label for="taskDesc"><strong>Full Report</strong></label>
                            <textarea name="report" id="taskDesc" class="form-control" cols="30" rows="8"
                                placeholder="Appraisal Report"></textarea>
                        </div>
    ...
    {{-- END OF MODALS --}}
     ...
     <!-- Dynamic Modal -->
     <div class="modal fade" id="apprMod" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
     aria-hidden="true">
     <div class="modal-dialog" role="document">
         <div class="modal-content">
             <div class="modal-header">
                 <h3 class="modal-title text-center" id="exampleModalLabel"> <span id="apprMod-header"> All Appraisals</span> </h3>
                 <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                     <span aria-hidden="true">&times;</span>
                 </button>
             </div>
             <div class="modal-body">
                 ...
                 <table class="table table-striped">
                    ...
                    <div class="mod-load" style="text-align: center;font-size:25px">
     ...
     <div class="modal fade" id="leaveMod" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
     aria-hidden="true">
     <div class="modal-dialog" role="document">
         <div class="modal-content">
             <div class="modal-header">
                 <h3 class="modal-title text-center" id="exampleModalLabel"> <span id="leaveMod-header"> All Leave Requests </span> </h3>
                 <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                     <span aria-hidden="true">&times;</span>
                 </button>
             </div>
     ...
     <div class="modal fade" id="trainMod" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
     aria-hidden="true">
     <div class="modal-dialog" role="document">
         <div class="modal-content">
             <div class="modal-header">
             ...
             <div class="modal-body">
                <div class="portlet light tasks-widget bordered">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="icon-share font-dark hide"></i>
                            <span class="caption-subject font-dark bold uppercase">Training Exercise</span>
 ...
 <button class="btn btn-outline" data-toggle="modal" data-target="#trainMod"> Open </button>
    ...
    <script>
        $(document).ready(function(){
            $('#apprMod').on('show.bs.modal', function(){
                $.get('/admin/appraisals', function(e){
                    $('.mod-load').hide()
                    var html = ''
                    for (const key in e) {
                        if (e.hasOwnProperty(key)) {
                            ...
                            html += `<tr><td> <img src="/img/user.png" /> &nbsp; &nbsp;` + element.employee + `</td><td> ` + element.summary +` </td><td><button onclick="event.preventDefault(); document.getElementById('appraisal-download{{$item->id}}').submit();" class="btn btn-icon-only blue"><span class="fa fa-download"></span></button</td></tr> <form action="/admin/download/appraisal/{{$item->id}}" method="POST" id="appraisal-download{{$item->id}}">@csrf</form>`
                        }
                    }
            ...
            // $('#leaveMod').on('show.bs.modal', function(){
            //     $.get('/admin/leaves', function(e){
            //         $('.mod-load').hide()
            //         var html = ''
            //         for (const key in e) {
            //             if (e.hasOwnProperty(key)) {
            //                 const element = e[key]
            //                 console.log(element.employee)
            //                 html += `<tr><td>` + element.employee + `</td><td> ` + element.summary +` </td><td><button onclick="event.preventDefault(); document.getElementById('appraisal-download{{$item->id}}').submit();" class="btn btn-icon-only blue"><span class="icon-cloud-download"></span></button</td></tr>`
            //             }
            //         }
            //         $('#table-body').html(html)
            //     })
